...
public class FrontEndServer {
    ...
    private static final String BASE_DIR = ".\\UI\\LoginPages"; // 🔥 Serve everything from this directory
    ...
    private static void serveStaticFile(String filePath, OutputStream out) throws IOException {
